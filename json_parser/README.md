...
3. Please see `sample.c`, `goto.c`, and `print_all.c` for usage examples. After running make:
	-  sample: `./sample "json_parser_tests/sample.json"`
	-  goto: `./goto json_parser_tests/random1.json [\"pairs\"][9][\"y..1\"][3][2][\"c..\"][2]`
	-  print_all: `./print_all "json_parser_tests/random1.json"`
